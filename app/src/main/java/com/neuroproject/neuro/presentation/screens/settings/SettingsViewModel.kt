package com.neuroproject.neuro.presentation.screens.settings
...
class SettingsViewModel @Inject constructor(
    ...
    private fun loadServerAddress() {
        ...
        if (!serverAddress.isNullOrEmpty()) {
            _state.update { it.copy(serverAddress = normalizeServerBaseUrl(serverAddress)) }
        }
    }
    ...
    fun onServerAddressChanged(newAddress: String) {
        val normalizedAddress = normalizeServerBaseUrl(newAddress)
        saveServerAddressToPreferences(normalizedAddress)
        _state.update {
            it.copy(
    ...
    private fun saveServerAddressToPreferences(address: String) {
        sharedPreferences.edit().putString("server_address", normalizeServerBaseUrl(address)).apply()
    }

    private fun normalizeServerBaseUrl(address: String): String {
